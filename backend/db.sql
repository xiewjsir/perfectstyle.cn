...
MySQL - 8.0.13 : Database - perfectstyle
*********************************************************************
*/
...
/*Table structure for table `admin_nodes` */

DROP TABLE IF EXISTS `admin_nodes`;

CREATE TABLE `admin_nodes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'menu' COMMENT '类型 menu 菜单,function 功能',
  `parent_id` int(11) NOT NULL DEFAULT '0',
  `sort` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `icon` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `method` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT 'ANY',
  `uri` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `level` tinyint(4) unsigned NOT NULL DEFAULT '0' COMMENT '层级 从0开始',
  `path` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '路径 包含自身ID',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `admin_nodes` */

insert  into `admin_nodes`(`id`,`type`,`parent_id`,`sort`,`name`,`icon`,`method`,`uri`,`level`,`path`,`created_at`,`updated_at`) values (1,'menu',0,1,'导航','-','ANY','#',0,'-1-','2018-12-27 07:17:19','2018-12-27 07:18:02'),(2,'menu',0,2,'组件','-','ANY','#',0,'-2-','2018-12-27 07:17:19','2018-12-27 07:17:54'),(3,'menu',0,3,'其它','-','ANY','#',0,'-3-','2018-12-27 07:17:19','2018-12-27 07:17:44'),(4,'menu',2,1,'权限管理','demo-psi-happy','ANY','#',1,'-2-4-','2018-12-27 07:17:19','2018-12-27 09:47:36'),(5,'menu',4,1,'管理员','-','GET,HEAD','adminUser.index',2,'-2-4-5-','2018-12-27 07:17:19','2018-12-28 06:14:16'),(6,'menu',4,0,'节点','-','GET,HEAD','adminNode.index',2,'-2-4-6-','2018-12-27 07:17:19','2018-12-28 06:13:09'),(7,'menu',2,0,'文章管理','demo-psi-pen-5','ANY','#',1,'-2-7-','2018-12-27 07:21:20','2018-12-27 07:47:12'),(8,'menu',7,0,'文章','-','GET,HEAD','post.index',2,'-2-7-8-','2018-12-27 07:47:01','2018-12-28 06:13:26'),(9,'menu',2,0,'多媒体','demo-psi-receipt-4','ANY','#',1,'-2-9-','2018-12-27 07:47:48','2018-12-27 07:49:05'),(10,'menu',9,0,'图片','-','GET,HEAD','file.index',2,'-2-9-10-','2018-12-27 07:48:25','2018-12-28 06:13:42'),(11,'menu',1,0,'仪表盘','demo-psi-home','ANY','admin.index',1,'-1-11-','2018-12-27 08:16:46','2018-12-27 08:16:46'),(12,'menu',3,0,'邮件','demo-psi-mail','ANY','#',1,'-3-12-','2018-12-27 08:17:26','2018-12-27 08:17:26'),(13,'function',5,0,'新增管理员','-','POST','adminUser.create',3,'-2-4-5-13-','2018-12-27 09:44:58','2018-12-28 05:01:25'),(14,'menu',4,0,'角色','-','GET,HEAD','adminRole.index',2,'-2-4-14-','2018-12-27 10:43:29','2018-12-28 06:15:57'),(19,'function',4,0,'权限','-','GET,HEAD','adminPermission.index',2,'-2-4-19-','2018-12-28 07:35:28','2018-12-28 07:35:28');

/*Table structure for table `admin_role_node_pivots` */

DROP TABLE IF EXISTS `admin_role_node_pivots`;

CREATE TABLE `admin_role_node_pivots` (
...
/*Data for the table `admin_role_node_pivots` */

insert  into `admin_role_node_pivots`(`role_id`,`node_id`) values (1,1),(1,2),(1,3),(1,4),(1,5),(2,1),(2,3);
...
insert  into `admin_roles`(`id`,`name_en`,`name_cn`,`description`,`created_at`,`updated_at`) values (1,'admin','超级管理员','a superman','2018-12-24 05:56:21','2018-12-28 09:08:35'),(2,'user','普通管理员','normal','2018-12-24 05:56:21','2018-12-28 09:19:12'),(3,'finance','财务专员','cc','2018-12-28 09:18:55','2018-12-28 09:18:55');

/*Table structure for table `admin_user_role_pivots` */

DROP TABLE IF EXISTS `admin_user_role_pivots`;

CREATE TABLE `admin_user_role_pivots` (
  `user_id` int(10) unsigned NOT NULL,
  `role_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`user_id`,`role_id`),
  KEY `role_user_role_id_foreign` (`role_id`),
  CONSTRAINT `role_user_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `admin_roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `role_user_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `admin_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `admin_user_role_pivots` */

insert  into `admin_user_role_pivots`(`user_id`,`role_id`) values (1,1),(1,2),(2,2);
...
CREATE TABLE `columns` (
  ...
  `slug` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '盐',
  `status` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'publish' COMMENT '发布状态',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
insert  into `columns`(`id`,`parent_id`,`name`,`slug`,`status`,`created_at`,`updated_at`) values (1,0,'好好学习','learn','publish','2018-12-18 17:38:24','2018-12-18 17:38:28'),(2,0,'好好生活','life','publish','2018-12-18 18:23:49','2018-12-18 18:23:52');
...
CREATE TABLE `files` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片标题',
  `type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '类型',
  `path` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片地址',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
/*Table structure for table `post_file_pivots` */

DROP TABLE IF EXISTS `post_file_pivots`;

CREATE TABLE `post_file_pivots` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `post_id` int(10) unsigned NOT NULL COMMENT '文章ID',
  `file_id` int(10) unsigned NOT NULL COMMENT '文件ID',
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal' COMMENT '文件ID',
...
/*Data for the table `post_file_pivots` */

insert  into `post_file_pivots`(`id`,`post_id`,`file_id`,`type`,`sort`,`created_at`,`updated_at`) values (1,1,60,'normal',0,NULL,NULL),(3,1,62,'normal',0,NULL,NULL),(4,2,63,'normal',0,NULL,NULL),(5,1,66,'normal',0,NULL,NULL),(6,3,67,'normal',0,NULL,NULL);

/*Table structure for table `post_tag_pivots` */

DROP TABLE IF EXISTS `post_tag_pivots`;
...
/*Data for the table `post_tag_pivots` */

insert  into `post_tag_pivots`(`id`,`post_id`,`tag_id`,`created_at`,`updated_at`) values (2,2,3,NULL,NULL),(4,2,1,NULL,NULL),(5,2,7,NULL,NULL),(6,1,8,NULL,NULL),(7,1,9,NULL,NULL),(8,1,10,NULL,NULL),(14,3,6,NULL,NULL);
...
CREATE TABLE `posts` (
  ...
  `summary` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '摘要',
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '内容',
  `post_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft' COMMENT '发布状态',
  `comment_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'open' COMMENT '评论状态',
  `post_password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '查看密码',
...
insert  into `tags`(`id`,`name`,`slug`,`created_at`,`updated_at`) values (1,'cc','','2018-12-19 04:53:03','2018-12-19 04:53:03'),(3,'DD','','2018-12-19 10:11:56','2018-12-19 10:11:56'),(6,'gg','','2018-12-19 10:37:18','2018-12-19 10:37:18'),(7,'ff','','2018-12-19 10:39:20','2018-12-19 10:39:20'),(8,'PHP','','2018-12-20 02:18:51','2018-12-20 02:18:51'),(9,'java','','2018-12-20 02:18:51','2018-12-20 02:18:51'),(10,'python','','2018-12-20 02:18:51','2018-12-20 02:18:51'),(15,'','','2018-12-21 10:32:59','2018-12-21 10:32:59');
