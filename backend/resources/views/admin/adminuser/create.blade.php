...
@section('content')
    ...
    <div id="page-content">
        <div class="panel">
            <!-- BASIC FORM ELEMENTS -->
            <!--===================================================-->
            <form id="admin-user-form" action="{{Route('adminUser.store')}}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-11">
                        <input type="text" name="name" id="name" value="" class="form-control" placeholder="名称">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-11">
                        <input type="text" name="email" id="email" value="" class="form-control" placeholder="邮箱">
                    </div>
                </div>
                <div class="form-group">
