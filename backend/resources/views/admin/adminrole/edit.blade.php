...
@section('content')
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">编辑角色</h1>
    ...
    <div id="page-content">
        <div class="panel">
            <!-- BASIC FORM ELEMENTS -->
            <!--===================================================-->
            <form id="admin-user-form" action="{{Route('adminRole.update',['id'=>$adminRole->id])}}"
                  class="panel-body form-horizontal form-padding">
                {{csrf_field()}}
                <div class="form-group">
                    <label class="col-md-1 control-label" for="name_cn">英文名称</label>
                    <div class="col-md-11">
                        <input type="text" name="name_en" id="name_en" value="{{$adminRole->name_en}}" class="form-control" placeholder="中文名称">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-1 control-label" for="name_cn">中文名称</label>
                    <div class="col-md-11">
                        <input type="text" name="name_cn" id="name_cn" value="{{$adminRole->name_cn}}" class="form-control" placeholder="中文名称">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-1 control-label" for="description">描述</label>
                    <div class="col-md-11">
                        <textarea name="description" id="description" rows="9" class="form-control" placeholder="输入描述..">{{$adminRole->description}}</textarea>
                    </div>
                </div>
                <div class="form-group">
