...
@section('content')
                        ...
                        <div class="pad-btm form-inline">
                            <div class="row">
                                <div class="col-sm-6 table-toolbar-left">
                                    <button class="btn btn-primary"><i class="demo-pli-add icon-fw"></i>Add</button>
    ...
    <!--Morris.js [ OPTIONAL ]-->
    <link href="{{asset('niftyadmin/plugins/morris-js/morris.min.css')}}" rel="stylesheet">
    ...
    <!--Morris.js [ OPTIONAL ]-->
    <script src="{{asset('niftyadmin/plugins/morris-js/morris.min.js')}}"></script>
    <script src="{{asset('niftyadmin/plugins/morris-js/raphael-js/raphael.min.js')}}"></script>


    <!--Sparkline [ OPTIONAL ]-->
    <script src="{{asset('niftyadmin/plugins/sparkline/jquery.sparkline.min.js')}}"></script>


    <!--Specify page [ SAMPLE ]-->
    <script src="{{asset('niftyadmin/js/demo/dashboard.js')}}"></script>
@endsection