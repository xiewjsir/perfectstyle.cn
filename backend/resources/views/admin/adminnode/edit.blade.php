...
@section('content')
    ...
    <div id="page-content">
        <div class="panel">
            <!-- BASIC FORM ELEMENTS -->
            <!--===================================================-->
            <form id="admin-user-form" action="{{Route('adminNode.update',['id'=>$adminNode->id])}}"
                  class="panel-body form-horizontal form-padding">
                {{csrf_field()}}
                <div class="form-group">
                    <label class="col-md-1 control-label" for="name">名称</label>
                    <div class="col-md-11">
                        <input type="text" name="name" id="name" value="{{$adminNode->name}}" class="form-control" placeholder="输入名称">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-1 control-label" for="parent_id">父级节点</label>
                    <div class="col-md-11">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-11">
                        <div class="radio">
                            ...
                            <input name="type" id="type_menu" class="magic-radio" type="radio" value="menu" @if('menu' == $adminNode->type)checked="" @endif>
                            <label for="type_menu">菜单</label>
                            <input name="type" id="type_function" class="magic-radio" type="radio" value="function" @if('function' == $adminNode->type)checked="" @endif>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-11">
                        <input type="text" name="icon" id="icon" value="{{$adminNode->icon}}" class="form-control" placeholder="输入图标">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-11">
                        <select name="method[]" id="method" multiple class="form-control">
                            @foreach($methods as $method)
                                <option value="{{$method}}" @if(in_array($method,$adminNode->method)) selected @endif>{{$method}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-11">
                        <input type="text" name="uri" id="uri" value="{{$adminNode->uri}}" class="form-control" placeholder="输入路路由">
                    </div>
                </div>
                <div class="form-group">
