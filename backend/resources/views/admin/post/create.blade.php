...
@section('content')
    ...
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="page-title">
        <h1 class="page-header text-overflow">写文章</h1>
        ...
        <div class="panel">
            ...
            <form id="posts-form" action="{{Route('post.store')}}" class="panel-body form-horizontal form-padding">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-11">
                        <input type="text" name="tag_names" id="tag_names" class="form-control" placeholder="Add a tag" value="" data-role="tagsinput">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-1 control-label" for="demo-text-input">概要</label>
                    <div class="col-md-11">
                        <textarea type="text" name="summary" id="summary" rows="3" class="form-control" placeholder="概要"></textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-11">
                        <textarea name="content" id="content" data-provide="markdown" rows="10"></textarea>
                    </div>
                </div>
                <div class="form-group">
            ...
            $("#posts-form").bootstrapValidator({
                ...
                $.ajax({
                    ...
                    success:function (result) {
                        if (200 == result['code']) {
                            layer.msg('发布文章成功', {time: 2000, icon: 1}, function () {
